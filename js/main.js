...
function buildSliderHintHtml(kt, text, bab) {
  ...
  const babHtml = babNum ? `<svg class="stationSliderHintBabSign" viewBox="0 0 33 18" width="33" height="18" overflow="visible"><polygon points="16.5,0 15.55,0.06 14.07,0.23 12.22,0.47 10.13,0.77 7.96,1.10 5.85,1.43 3.95,1.73 2.42,1.98 1.38,2.15 1.01,2.21 0.84,2.24 0.68,2.30 0.54,2.37 0.41,2.46 0.29,2.57 0.19,2.69 0.11,2.82 0.05,2.96 0.01,3.11 0,3.27 0,14.73 0.01,14.89 0.05,15.04 0.11,15.18 0.19,15.31 0.29,15.43 0.41,15.54 0.54,15.63 0.68,15.70 0.84,15.76 1.01,15.79 1.38,15.85 2.42,16.02 3.95,16.27 5.85,16.57 7.96,16.90 10.13,17.23 12.22,17.53 14.07,17.77 15.55,17.94 16.5,18 17.43,17.94 18.90,17.77 20.75,17.52 22.84,17.22 25.01,16.89 27.13,16.57 29.03,16.27 30.58,16.02 31.61,15.85 31.99,15.79 32.16,15.76 32.32,15.70 32.46,15.63 32.59,15.54 32.71,15.43 32.81,15.31 32.89,15.18 32.95,15.04 32.99,14.89 33,14.73 33,3.27 32.99,3.11 32.95,2.96 32.89,2.82 32.81,2.69 32.71,2.57 32.59,2.46 32.46,2.37 32.32,2.30 32.16,2.24 31.99,2.21 31.61,2.15 30.58,1.98 29.03,1.73 27.13,1.43 25.01,1.11 22.84,0.78 20.75,0.48 18.90,0.23 17.43,0.06" fill="none" stroke="white" stroke-width="1.2"/><text x="16.5" y="9" dominant-baseline="central" text-anchor="middle" font-family="ddin-regular,sans-serif" font-size="11" fill="white">${escapeSvgText(babNum)}</text></svg>` : '';
